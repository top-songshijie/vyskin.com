...
//    function get_treeview_menu2($myid,$effected_id='example', $str="<span class='file'>\$name</span>", $str2="<span class='folder'>\$name</span>", $showlevel = 0,  $ul_class="" ,$li_class="" , $style='filetree ', $currentlevel = 1, $recursion=FALSE, $dropdown='hasChild') {
//        $child = $this->get_child($myid);
//        if (!defined('EFFECTED_INIT')) {
//            $effected = ' id="' . $effected_id . '"';
//            define('EFFECTED_INIT', 1);
...
//    }
    ...
    function get_treeview_menu2($myid,$effected_id='example', $str="<span class='file'>\$name</span>", $str2="<span class='folder'>\$name</span>", $showlevel = 0,  $ul_class="" ,$li_class="" , $style='filetree ', $currentlevel = 1, $recursion=FALSE, $dropdown='hasChild') {
        ...
        foreach ($child as $id => $a) {
            ...
            if ($this->get_child($a['id'])) {
                ...
                $this->str .= $nstr;
                if ($showlevel == 0 || ($showlevel > 0 && $showlevel > $currentlevel)) {
                    $this->get_treeview_menu($a['id'], $effected_id, $str, $str2, $showlevel,   $ul_class ,'second' ,$style, $currentlevel + 1, TRUE);
                } elseif ($showlevel > 0 && $showlevel == $currentlevel) {
                    //$this->str .= $placeholder;
                }
            } else {
    ...
    function get_treeview_menu3($myid,$effected_id='example', $str="<span class='file'>\$name</span>", $str2="<span class='folder'>\$name</span>", $showlevel = 0,  $ul_class="" ,$li_class="" , $style='filetree ', $currentlevel = 1, $recursion=FALSE, $dropdown='hasChild') {
        $child = $this->get_child($myid);
        if (!defined('EFFECTED_INIT')) {
            $effected = ' id="' . $effected_id . '"';
            define('EFFECTED_INIT', 1);
        ...
        foreach ($child as $id => $a) {
            ...
            if ($this->get_child($a['id'])) {
                ...
                $this->str .= $nstr;
                if ($showlevel == 0 || ($showlevel > 0 && $showlevel > $currentlevel)) {
                    $this->get_treeview_menu($a['id'], $effected_id, $str, $str2, $showlevel,   $ul_class ,'footer_second' ,$style, $currentlevel + 1, TRUE);
                } elseif ($showlevel > 0 && $showlevel == $currentlevel) {
                    //$this->str .= $placeholder;
                }
            } else {
